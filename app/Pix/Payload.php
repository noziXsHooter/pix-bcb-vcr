...
class Payload {
  ...
  /**
    ...
    /**
     * Método responsável por retornar o valor completo do objeto do payload
     * @param string  $id
     * @param string  $value
    ...
    /**
     * Método responsável por retornar os valores completos da info da conta
     * @param string
     */
    private function getMerchantAccountInformation(){
      ...
      //DESCRIÇÂO DO PAGAMENTO
        ...
        return $this->getValue(self::ID_MERCHANT_ACCOUNT_INFORMATION, $gui.$key.$description);
            ...
            /**
     * Método responsável por retornar os valores completo do campo adcional
     * @param string
     */
    private function getAdditionalDataFieldTemplate() {
     ...
     /**
     * Método responsável por gerar codigo completo do payload PIX
     * @param string
     */
